...
Version  : 0.3.0
Release  : 17
URL      : http://cran.r-project.org/src/contrib/scales_0.3.0.tar.gz
Source0  : http://cran.r-project.org/src/contrib/scales_0.3.0.tar.gz
...
/usr/lib64/R/library/scales/NEWS
